...
<?php
    ...
    $request = $conn->query("SELECT tblborrow.*, tblbook.BTitle, tblbook.FullCode, tblguest.FirstName, tblguest.LastName
        ...
        WHERE tblborrow.DateReturned IS NULL");
?>

<div class="p-2">
    <div class="card">
        <div class="card-header">
            <h4 style=" font-family: Moul;">សំណើសងសៀវភៅ</h4>
        </div>
    </div>
        ...
        while ($requests = $request->fetch_object()) {
            if ($previousBorrowCode !== null && $previousBorrowCode !== $requests->BorrowCode) {
                ...
                <div class="container-fluid">
                    <a href="<?php echo $burl . "/admin/return/view.php?borrow_code=" . $previousBorrowID ?>" class="card mb-3 card-hover" style="border-radius: 10px; text-decoration: none;">
                        <div class="row g-0">
                            <div class="col-md-10">
                                <div class="card-body">
                            ...
                            <div class="col-md-2 text-end align-self-center px-3">
                                <span class="badge bg-success">រចចាំសងសៀវភៅ</span>
                                <span class="badge bg-warning">ខ្ចីបន្ដ</span>
                            </div>
                        </div>
                    </a>
                </div>
